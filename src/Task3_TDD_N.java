...
public class Task3_TDD_N {
	...
	public void test_order_of_search() {
		parser.add("output", "o", Parser.INTEGER_LIST);
		parser.add("output2", "output", Parser.INTEGER_LIST);
	...
	public void test_order_of_search_option_shortcut() {
		parser.add("output1", "o1", Parser.INTEGER_LIST);
		parser.add("output2", "o2", Parser.INTEGER_LIST);
